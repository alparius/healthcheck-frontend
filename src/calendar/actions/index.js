...
export const loadActivities = (dispatch) => {
    return (dispatch) => {
        ...
        return axiosInstance
            .get(`http://localhost:8080/api/activity/getUserActivities?userid=${token.userId}`)
...
export const deleteActivity = (activityId, dispatch) => {
    return (dispatch) => {
        return axiosInstance
            .post(`http://localhost:8080/api/activity/leader/delete?activityId=${activityId}`)
...
export const createActivity = (activity, dispatch) => {
    return (dispatch) => {
        ...
        return axiosInstance
            .post("http://localhost:8080/api/activity/leader/add", activity)
...
export const updateActivity = (activity, dispatch) => {
    return (dispatch) => {
        ...
        activity.userid = token.userId;
        return axiosInstance
            .post("http://localhost:8080/api/activity/leader/update", activity)
