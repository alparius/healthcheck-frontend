...
import { LOGIN_REQUEST, LOGIN_FAILURE, LOGIN_SUCCESS, LOGOUT_REQUEST, LOGOUT_SUCCESS, LOGOUT_FAILURE } from "./actionTypes";
...
export const logoutUser = () => {
    ...
    return async (dispatch) => {
        ...
        try {
            await axios.post("http://localhost:8080/api/user/logout", data, config);
