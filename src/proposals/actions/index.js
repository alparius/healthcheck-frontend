...
export const loadProposals = (dispatch) => {
    return (dispatch) => {
        ...
        return axiosInstance
            .get(`http://localhost:8080/api/proposal/getProposalOptionalWithStatus?currentWeek=true`)
...
export const deleteProposal = (proposalId, showMessage, dispatch) => {
    return (dispatch) => {
        return axiosInstance
            .post(`http://localhost:8080/api/proposal/delete?proposalId=${proposalId}`)
...
export const createProposal = (proposal, dispatch) => {
    return (dispatch) => {
        delete proposal.id;
        return axiosInstance
            .post("http://localhost:8080/api/proposal/add", proposal)
...
export const updateProposal = (proposal, dispatch) => {
    return (dispatch) => {
        return axiosInstance
            .post("http://localhost:8080/api/proposal/update", proposal)
...
export const voteProposal = (proposalId, dispatch) => {
    return (dispatch) => {
        return axiosInstance
            .post(`http://localhost:8080/api/vote/addVote?proposalId=${proposalId}`)
...
export const unlikeProposal = (proposalId, dispatch) => {
    return (dispatch) => {
        return axiosInstance
            .post(`http://localhost:8080/api/vote/removeVote?proposalId=${proposalId}`)
...
export const acceptProposal = (proposalId, dispatch) => {
    return (dispatch) => {
        return axiosInstance
            .post(`http://localhost:8080/api/proposal/leader/acceptProposal?proposalId=${proposalId}`)
